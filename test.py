...
class MainPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = ttk.Label(self, text = "Graphs")
        button1.grid(row = 1, column=0, sticky = 'nswe')

        button2 = ttk.Label(self, text = "Page 2")
        button2.grid(row = 1, column=1, sticky = 'nswe')

        button2 = ttk.Label(self, text = "Page 2")
        button2.grid(row = 1, column=2, sticky = 'nswe')
